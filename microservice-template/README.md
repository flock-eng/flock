...
Don't forget to add `.github/workflows/{{SERVICE_NAME}}.yml` to push to docker hub. There is a file called `github-actions-template.yml` that you can copy and modify. Don't forget to rename it.
