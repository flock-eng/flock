...
func TestLoadConfig(t *testing.T) {
	...
	t.Run("environment variables override defaults", func(t *testing.T) {
		...
		os.Setenv("TEMPLATE_SERVER_PORT", "9090")
		os.Setenv("TEMPLATE_LOGGER_LEVEL", "debug")
		defer func() {
			os.Unsetenv("TEMPLATE_SERVER_PORT")
			os.Unsetenv("TEMPLATE_LOGGER_LEVEL")
		}()
	...
	t.Run("invalid configuration returns error", func(t *testing.T) {
		...
		os.Setenv("TEMPLATE_SERVER_READ_TIMEOUT", "invalid")
		defer os.Unsetenv("TEMPLATE_SERVER_READ_TIMEOUT")
...
func TestConfig_Validation(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			modifyEnv: func() {
				os.Setenv("TEMPLATE_SERVER_PORT", "invalid")
			},
		...
		},
		{
			...
			modifyEnv: func() {
				os.Setenv("TEMPLATE_SERVER_WRITE_TIMEOUT", "invalid")
			},
			wantErr: true,
		},
	}
